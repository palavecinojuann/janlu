...
export default function App() {
  const { 
    ...
    fetchInitialAuditLogs, fetchMoreAuditLogs, hasMoreLogs, loadingLogs, loadUsersAndPreAuth, loadFinancialDocs, loadSimulations, loadProductionOrders, loadCoupons, loadAllSales,
